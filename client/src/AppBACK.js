...
class App extends Component {
  ...
  state               = { addresses:null, events:null, nbVoters:null, MaxVoters:null, nbProposals:null, MaxProposals:null, proposals:null, oneProposal:null, totalVotes:null, /*voter:0,*/ winner:0, workflowStatus:null, owned:null, web3:null, accounts:null, contract:null};
  ...
  commonGetProposalList(){
    if(this.state.nbProposals>0){
      return(
        <div>
        <p>
          <strong>Liste actuelle des Propositions :</strong>{console.log(this.state.proposals)}
